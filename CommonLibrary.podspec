...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of CommonLibrary.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/21DerickDerick@gmail.com/CommonLibrary'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '21DerickDerick@gmail.com' => 'Derick.Derick@rakuten.com' }
  s.source           = { :git => 'https://github.com/21DerickDerick@gmail.com/CommonLibrary.git', :tag => s.version.to_s }
